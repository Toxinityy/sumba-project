  ...
  <div class="mx-auto max-w-content px-4 pb-12 pt-20">
    <div class="mb-16 grid gap-12 md:grid-cols-3">
      ...
      <div class="flex flex-col gap-2">
        ...
        {{-- gallery.index/impact/projects are deferred past launch (spec
             §10) but built for this review pass, so they're listed here
             too — see docs/agent-a-pages-report.md, Pass 4. --}}
        @foreach (['about', 'schools.index', 'homes.index', 'stories.index', 'gallery.index', 'impact', 'projects'] as $name)
      ...
      <div class="flex flex-col gap-2">
        ...
        <a href="{{ route("{$locale}.partners") }}" class="flex min-h-11 items-center hover:underline">{{ __('nav.partners') }}</a>
